...
# Demo:
# cd ~ann/pd101/data/
# python ~ann/pd101/pd101.py GSPC2.csv
# python ~ann/pd101/pd101.py GLD2.csv
# ...
...
# I should read ~ann/pd101/data/GSPC2.csv etc
...
if len(sys.argv) == 1:
  print('Demo:')
  print('cd ~ann/pd101/data/')
  print('python ~ann/pd101/pd101.py GLD2.csv')
  print('...')
  sys.exit()
