# ~ann/pd101/plot/pd101.py

# This script should create features

# Demo:
# cd /tmp/pd101/
# python ~ann/pd101/plot/pd101.py GSPC2.csv
# python ~ann/pd101/plot/pd101.py GLD2.csv
# ...

print('hello, from pd101.py')

import pandas as pd
import numpy  as np
import pdb

# I should read /tmp/pd101/GSPC2.csv etc
...
if len(sys.argv) == 1:
  print('Demo:')
  print('cd /tmp/pd101/')
  print('python ~ann/pd101/plot/pd101.py GLD2.csv')
  print('...')
  sys.exit()
